...
# -*- coding: utf-8 -*-
#
# achallonge documentation build configuration file, created by
...
htmlhelp_basename = 'achallongedoc'
...
latex_documents = [
    (master_doc, 'achallonge.tex', 'achallonge Documentation',
     'fp12', 'manual'),
]
...
man_pages = [
    (master_doc, 'achallonge', 'achallonge Documentation',
     [author], 1)
]
